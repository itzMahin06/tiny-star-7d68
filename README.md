...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/admission-photocard#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/admission-photocard
```

A live public deployment of this template is available at [https://admission-photocard.templates.workers.dev](https://admission-photocard.templates.workers.dev)
